...
namespace RetrievalAgent.Agents
{
    public class RetrievalCompletionAgent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrievalCompletionAgent"/> class.
        /// </summary>
        ...
        /// <returns>An instance of <see cref="RetrievalCompletionAgentResponse"/></returns>
        public async Task<RetrievalCompletionAgentResponse?> InvokeAgentAsync(string input, ChatHistory chatHistory)
        {
            ...
            try
            {
                ...
                var result = JsonSerializer.Deserialize<RetrievalCompletionAgentResponse>(resultContent);
                this.retryCount = 0;
                return result;
            }
